...
public class Coin extends Item {
    ...
    public Coin(PlayScreen screen, float x, float y) {
        super(screen, x, y);
        textureRegion = new TextureRegion(new Texture(Gdx.files.local("sprites/objects/Coin_01.png")));
    ...
    public void defineItem() {
        ...
        fDef.filter.categoryBits = Platformer.COIN_BIT;
        fDef.filter.maskBits = Platformer.GROUND_BIT | Platformer.OBJECT_BIT | Platformer.PLAYER_BIT;
    ...
    public void use(Player player) {
        player.incrementCoins(this.value);
        this.toDestroy = true;
    }
}
